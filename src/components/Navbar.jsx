  ...
  return (
    <nav className="w-full h-14 border border-gray-200 fixed z-50 top-0 left-0 right-0 bg-white">
      <div className="flex flex-row h-full ">
        <div className="flex-4 sm:flex-initial flex flex-row justify-around items-center ">
          <div className="ml-7 ">
            <FiMenu
          ...
          <div className="mr-3">
            <img
              className=" h-6 sm:h-6 sm:w-27 ml-5 sm:ml-4"
              src="/Logo.png"
              alt="Logo"
            />
          </div>
        ...
        {/* search */}
        <div className="sm:flex-5 flex-5 flex flex-row items-center justify-between ">
          <div className=" sm:relative sm:bg-gray-100 rounded-3xl px-10 py-3  text-sm text-slate-950 ml-4  ">
            <input
              type="text"
              placeholder="Search"
              className="hidden sm:block ml-5 focus:outline-none  "
            />
          </div>
        ...
        <div className=" flex flex-1 sm:flex-inital flex-row items-center justify-around sm:px-6 ">
          ...
          <div
            ...
            className="w-8 h-8 rounded-full bg-green-600 hover:bg-green-700 transition-colors flex items-center justify-center sm:mr-1 mr-5 ml-2 cursor-pointer "
          >
